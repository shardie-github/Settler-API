...
class MatchingEngine {
     ...
     */
    async matchByTransactionId(transactions, settlements, _rule, tenantId, executionId, jobId) {
        const matches = [];
        const exceptions = [];
        // Create lookup map
     ...
     */
    async matchByAmount(transactions, settlements, rule, tenantId, executionId, jobId) {
        const matches = [];
        const exceptions = [];
     ...
     */
    async matchByDate(transactions, settlements, rule, tenantId, executionId, jobId) {
        const matches = [];
        const exceptions = [];
     ...
     */
    async matchByReferenceId(transactions, settlements, rule, tenantId, executionId, jobId) {
        const matches = [];
        const exceptions = [];
        const threshold = rule.threshold || 0.8;
        for (const transaction of transactions) {
     ...
     */
    async matchByMultipleFields(_transactions, _settlements, _rule, _tenantId, _executionId, _jobId) {
        const matches = [];
        const exceptions = [];
     ...
     */
    extractTransactionIdsFromSettlement(settlement) {
        const ids = [];
