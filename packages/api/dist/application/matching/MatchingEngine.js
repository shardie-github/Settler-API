...
class MatchingEngine {
     ...
     */
    async matchByTransactionId(transactions, settlements, rule, tenantId, executionId, jobId) {
        const matches = [];
        const exceptions = [];
        // Create lookup map
     ...
     */
    async matchByMultipleFields(transactions, settlements, rule, tenantId, executionId, jobId) {
        const matches = [];
        const exceptions = [];
